...
function LoginForm({ onLogin }: { onLogin: (username: string) => void }) {
  ...
  return (
    <div className="p-8 bg-white rounded-lg shadow-md max-w-md w-full">
      <h1 className="text-3xl font-bold text-center mb-6 text-blue-600">Hakil<span className="relative">y<span className="absolute -top-2 right-[-22px] text-2xl">💡</span></span></h1>
