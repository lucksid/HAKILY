...
function LoginForm({ onLogin }: { onLogin: (username: string) => void }) {
  ...
  return (
    <div className="p-8 bg-white rounded-lg shadow-md max-w-md w-full">
      <h1 className="text-3xl font-bold text-center mb-6 text-blue-600">Hakil<span className="relative">y<span className="absolute -top-4 -right-3">💡</span></span></h1>
  ...
  return (
    <div className="max-w-6xl w-full mx-auto" ref={lobbyContainerRef}>
      <header className="bg-white p-4 rounded-lg shadow-md mb-6 flex justify-between items-center">
        <h1 className="text-2xl font-bold text-blue-600">Hakil<span className="relative">y<span className="absolute -top-3 -right-3 text-sm">💡</span></span></h1>
